  ...
  return (
    <div className="relative bg-jugaad-card border-2 border-black rounded-lg p-5 mb-6 shadow-sketch transition-transform hover:-translate-y-0.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 relative z-10">
        ...
        {/* Left Column: Route & Timeline details */}
        <div className="lg:col-span-6 space-y-4 flex flex-col justify-between">
               ...
               <div className="flex flex-col gap-0 relative">
                  ...
                  <div className="flex items-center gap-3 relative z-10">
                      ...
                      <div className="flex-1 bg-gray-50 border border-gray-200 rounded p-2">
                          <div className="flex justify-between items-center mb-1">
                              <span className="font-bold text-sm font-comic text-black">
                          ...
                          <div className="text-xs font-mono text-gray-600 font-bold">
                              {route.legs[0].sourceStation} <span className="mx-1 text-black">➔</span> {route.legs[0].destinationStation}
                          </div>
                  ...
                  {route.type === 'split' && (
                      <div className="flex flex-col items-center gap-2 relative z-10">
                          <div className={`border-2 border-black px-4 py-2 rounded-lg text-xs font-bold flex flex-col items-center justify-center transform rotate-1 shadow-sm max-w-[95%] text-center ${isSeatSplit ? 'bg-cyan-100 text-black' : 'bg-yellow-100 text-black'}`}>
                  ...
                  {route.legs[1] && (
                      <div className="flex items-center gap-3 relative z-10">
                          ...
                          <div className="flex-1 bg-gray-50 border border-gray-200 rounded p-2">
                              ...
                              <div className="text-xs font-mono text-gray-600 font-bold">
                                  {route.legs[1].sourceStation} <span className="mx-1 text-black">➔</span> {route.legs[1].destinationStation}
                              </div>
                              <div className="text-[10px] text-gray-500">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded p-3 text-xs italic font-comic text-black shadow-inner flex gap-2">
            <span>💡</span>
            <p className="leading-relaxed">{route.reason}</p>
          </div>
        </div>

        {/* Right Column: Price comparison & Buttons */}
        <div className="lg:col-span-6 flex flex-col justify-between space-y-4">
          
          {/* Fares Panel */}
          <div className="bg-white border-2 border-black rounded p-4 shadow-[2px_2px_0px_rgba(0,0,0,1)] flex-grow flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-3">
                    {(() => {
                        ...
                        return route.fareAnalysis.prices.map((price, idx) => {
                            ...
                            return (
                                <div key={idx} className={`p-3.5 rounded border-2 border-black transition-all ${price.isCheapest ? 'bg-green-50' : 'bg-gray-50'}`}>
          ...
          <div className="space-y-2">
            ...
            <button 
               ...
               className="w-full bg-[#FF5722] hover:bg-[#E64A19] text-white font-display text-base py-3 px-4 border-4 border-black shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:translate-y-0.5 hover:shadow-none transition-all flex items-center justify-center gap-2 active:translate-y-1 rounded-[30px_8px_25px_6px]"
            >
               <span>⏰</span> 
            ...
            <button 
               ...
               className="w-full bg-yellow-100 text-black font-display text-xs py-2 px-4 border-2 border-black shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:translate-y-0.5 hover:shadow-none transition-all flex items-center justify-center gap-2 active:translate-y-1 rounded"
            >
               <span>📐</span> 
